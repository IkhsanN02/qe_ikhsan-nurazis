...
public class Register {
    ...
    public void sendPOSTHTTPRequestWithValidEndpointForRegister(){
        ...
        String email = "ikhsannurazis22" + String.valueOf(number) + "@gmail.com";

        String body = "{\"email\": " + email + ",\n" +
                " \"password\": \"ikhsan22\" ,\n" +
                " \"fullname\": \"Ikhsan Nurazis\"}";
    ...
    public void sendPOSTHTTPRequestWithInvalidEndpointForRegister(){
        String body = "{\"email\": \"ikhsannurazis22@gmail.com\", \"password\": \"ikhsan22\", \"fullname\": \"Ikhsan Nurazis\"}";
